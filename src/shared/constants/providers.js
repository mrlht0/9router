...
export const APIKEY_PROVIDERS = {
  ...
  windsurf: { id: "windsurf", alias: "ws", name: "Windsurf", icon: "surfing", color: "#00BFA6", textIcon: "WS", website: "https://windsurf.com", notice: { text: "Extract token from Windsurf app (sk-ws-01-...). See issue #332 for extraction guide.", apiKeyUrl: "https://windsurf.com" }, serviceKinds: ["llm"] },
