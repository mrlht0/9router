...
export const APIKEY_PROVIDERS = {
  swiftrouter: { id: "swiftrouter", alias: "swiftrouter", name: "SwiftRouter", icon: "bolt", color: "#0EA5E9", textIcon: "SR", website: "https://swiftrouter.com", notice: { text: "OpenAI-compatible API with curated recent and popular models. The /models endpoint requires an API key.", apiKeyUrl: "https://swiftrouter.com" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://api.swiftrouter.com/v1/models", type: "openai" } },
