...
export const APIKEY_PROVIDERS = {
  ...
  agentrouter: { id: "agentrouter", alias: "ar", name: "AgentRouter", icon: "router", color: "#7C3AED", textIcon: "AR", website: "https://agentrouter.org", notice: { text: "Unified LLM gateway. Sign in via GitHub or Linux.do, then create an API key.", apiKeyUrl: "https://agentrouter.org/console" }, passthroughModels: true, serviceKinds: ["llm"] },
  bluesminds: { id: "bluesminds", alias: "bm", name: "Bluesminds", icon: "router", color: "#0EA5E9", textIcon: "BM", website: "https://api.bluesminds.com", notice: { text: "Unified LLM gateway. Get an API key from the Bluesminds console.", apiKeyUrl: "https://api.bluesminds.com/console" }, passthroughModels: true, serviceKinds: ["llm"] },
