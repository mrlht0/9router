...
export default {
  ...
  display: {
    ...
    color: "#3B82F6",
    textIcon: "EX",
    website: "https://provider.example.invalid",
    notice: { apiKeyUrl: "https://provider.example.invalid/keys" }, // or signupUrl.
  ...
  transport: {
    baseUrl: "https://api.provider.example.invalid/v1/chat/completions",
    format: "openai",            // "openai" | "claude" | "gemini" | "openai-responses" | ...
    // validateUrl: "https://api.provider.example.invalid/v1/models",
    ...
    // usage: { url: "https://api.provider.example.invalid/usage" }, // or { urls: [...] } for multi-call.
    // modelsFetcher: { url: "https://api.provider.example.invalid/models", type: "openai" }, // dynamic model list.
  ...
  // oauth: {
  //   clientId: "app_xxx",
  //   authorizeUrl: "https://auth.provider.example.invalid/oauth/authorize", // PKCE/code flow.
  //   tokenUrl: "https://auth.provider.example.invalid/oauth/token",
  //   deviceCodeUrl: "https://auth.provider.example.invalid/device",          // device-code flow.
  //   refreshUrl: "https://auth.provider.example.invalid/oauth/token",
  ...
  //   imageConfig:     { baseUrl: "https://api.provider.example.invalid/v1/images/generations" },
  //   searchViaChat:   { defaultModel: "ex-search", pricingUrl: "https://provider.example.invalid/pricing" },
  //   // hiddenKinds: ["image"],
  // },
